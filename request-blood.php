<?php
    ...
    /*
        Template Name: Request For Blood
    ...
    */
    ...
    $page_name = $site_name_short . ' - Request For Blood';
        ...
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST"){
                /* 
                    ...
                    - # Don't touch here
                */
                require_once $tpl . 'request-blood/data.php';
            }else{
                /* 
                    - Template for Who need blood or request lists
                    ...
                    - # Don't touch here
                */
                require_once $tpl . 'request-blood/content.php';
            }
