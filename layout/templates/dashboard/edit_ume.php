<div id="edit_profile">
    <form action="./dashboard.php?action=edit_profile_update" method="POST" name="edit_profile_form" id="edit_profile_form">
        ...
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input value="<?php echo get_user_info($_SESSION['id'], 'mobile'); ?>" name="mobile" class="mdl-textfield__input" type="text" id="mobile">
        ...
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input value="<?php echo get_user_info($_SESSION['id'], 'email'); ?>" name="email" class="mdl-textfield__input" type="email" id="email">
...
getJSON('http://localhost/febbms/layout/assets/resource/bd_district.json', function(err, data) {
...
submit_button.addEventListener('click', function() {
    ...
    if (verify('name') == true && verify('bloodgroup') == true && verify('mobile') == true && verify(
            'gender') == true && verify('district') == true && verify('address') == true) {
        // Submitted Success
