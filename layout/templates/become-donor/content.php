...
<main id="become_donor">
    <form action="./become-donor.php" method="POST" name="become_donor_form" id="become_donor_form">
        ...
        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            ...
            <input name="lastDateOfDonate" class="mdl-textfield__input" type="date" id="lastDateOfDonate">
        </div>

        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <span>Date of Birth</span>
            <input name="dob" class="mdl-textfield__input" type="date" id="dob">
        </div>
...
submit_button.addEventListener('click', function() {
    ...
    if (verify('name') == true && verify('bloodgroup') == true && verify('mobile') == true && verify(
            'gender') == true && verify('district') == true && verify('address') == true && verify('pass') ==
        true && verify('repass') == true) {
        // Submitted Success
        document.become_donor_form.submit();
    } else {
